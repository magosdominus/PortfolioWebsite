...
else if($_SERVER["REQUEST_METHOD"] == "POST")
{
	 ...
	 if($error == "")
	{
		...
		//echo "cities are ".$city_names_output;
...
var counter =0;
		for (var i in city_checkboxes){
		//SAME AS for ( i = 0; i < city_checkboxes.length; i++){
			if(city_checkboxes[i].checked){
			
			cities +=city_checkboxes[i].className +", ";
			cityList[counter]=city_checkboxes[i].value;
			
			counter +=1;
			}
		}
setCookie("city_name_list",cities,5);	
setCookie("city_value_list",cityList,5);	
			...
			<div id="table">
				<form action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="post" >
					<table style="margin-left:auto; margin-right:auto;" >
						...
						<tr><td colspan=3 align="center"><br/><br/><input type="Submit" onclick="getAllCities();"  id="enter_button" name="btnEnter" value="Enter"size="20"></input>
