	...
	{		
		...
		{ 
			  ...
			  $output .= " and you last accessed our system: ".pg_fetch_result($result,"last_access");
				...
				if ($userInformation["user_type"] == CLIENT || $userInformation["user_type"] == INCOMPLETE_CLIENT )
				{
					header('Location: user_dashboard.php');
				}
				elseif ($userInformation["user_type"] == ADMIN)
				{
				
					header('Location: admin_dashboard.php');
				}
				elseif ($userInformation["user_type"] == DISABLED_CLIENT)
				{
					 $error = "<h2>NO access for you ! sorry. \n Your account has been disabled, Please contact system administrator</h2>";
