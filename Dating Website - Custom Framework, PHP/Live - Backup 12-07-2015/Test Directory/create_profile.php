...
elseif(($_SESSION["user"]["user_type"] == CLIENT || $_SESSION["user"]["user_type"] == ADMIN ))
{
...
else if($_SERVER["REQUEST_METHOD"] == "POST")	
{
	...
	if ($error == "")
	{
		...
		//$sql ="INSERT INTO profiles (user_id, user_bio, user_picture, user_headline, match_description, city, gender, gender_sought, relationship_sought, body_type, height, horoscope, ethnicity, religion, relationship_status, children, smoking, education, occupation, interests) VALUES (".$user_name.")";
		//	echo $sql;											
		pg_execute($conn, "create_user_profile", array($user_name, $txtProfileDescription, '0', $txtProfileHeadline, $txtMatchDescription, $city, $gender, 
