<?php
$title="WEDE3201 - Terms and Condition";
$fileName="terms.php";
$date="15th-Sept-2015";
$Description= "This page displays the terms and condition of the website";
$banner="My homepage";
include ("header.php");
?> 
<h1>Terms &amp; Conditions</h1>
<p>(Last Revised: May 14, 2014)</p>
<p>These terms and conditions govern your use of this web site. By accessing this web site, you are acknowledging and accepting these terms and conditions. These terms and conditions are subject to change by SingleAndOver50 (hereinafter &quot;Company&quot;) at any time and at our discretion without notice. Your use of this web site after any changes are implemented constitutes your acceptance of the changes. As a result, we encourage you to consult the terms and conditions each time you use this web site.</p>
...
<p>As noted above, reproduction, copying, or redistribution for commercial purposes of any materials or design elements on this site is strictly prohibited without the express written permission of COMPANY. For information on requesting such permission, please contact us using the contact information listed in Section 5 herein.</p>

<h2>2. Third Party References / Hyperlinks</h2>
...
<h2>3. Ability To Accept Terms And Conditions</h2>
...
<p>UNDER NO CIRCUMSTANCES SHALL COMPANY OR ITS AGENTS BE LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES THAT RESULT FROM THE USE OF, OR INABILITY TO USE, THIS SITE. THIS LIMITATION APPLIES WHETHER THE ALLEGED LIABILITY IS BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY, OR ANY OTHER BASIS, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. YOU AGREE THAT THE MAXIMUM AGGREGRATE LIABILITY OF COMPANY SHALL BE LIMITED TO THE AMOUNT YOU PAID TO COMPANY FOR SERVICES. BECAUSE SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, COMPANY'S LIABILITY IN SUCH JURISDICTIONS SHALL BE LIMITED TO THE EXTENT PERMITTED BY LAW. </p>
...
<h2>7. Severability And Integration</h2>
...
<p>These Terms and Conditions shall be governed by and construed in accordance with the laws of the State of Florida. You hereby consent to binding arbitration to resolve any disputes arising under these Terms and Conditions.</p>
<p>&nbsp;</p>
<?php
include ("footer.php");
?>