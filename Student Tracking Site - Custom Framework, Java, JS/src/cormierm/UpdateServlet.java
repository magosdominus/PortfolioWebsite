...
/**
 * Description: Update Serlvet - updates student record.
    ...
    public void doPost(HttpServletRequest request,
					...
					throws ServletException, IOException
		{
	            ...
	            {   // retrieve data from DB
	                login = session.getAttribute("userID").toString(); //this is the name of the text input box on the form
	                ...
	                session.setAttribute("logoutMessage", "You account has been updated.");
